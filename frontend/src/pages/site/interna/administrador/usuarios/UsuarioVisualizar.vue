    ...
    <b-col md="12" sm="8">
      <b-card no-body class="mx-4">
                ...
                <b-form-group label="Confirme o e-mail: *">
                  <b-input-group class="mb-3">
                    ...
                    <b-form-input type="text"
                                  ...
                                  :state="chkState('confirmaEmail')" disabled/>
              ...
              <b-col cols="4">
                <b-form-group label="Tipo de Usuário: *">
                  <b-form-select v-model.trim="$v.form.tipoUsuario.$model" :state="chkState('tipoUsuario')"
                                 placeholder="Tipo de Usuário" class="mb-3" disabled>
        ...
        <b-card-footer class="p-12">
          <b-row>
            <b-col md="3"  v-if="can('user.update')" >
              <b-button block variant="primary" v-on:click="editarUsuario()">
            ...
            <b-col md="3" v-if="can('user.index')">
