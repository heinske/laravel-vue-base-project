<template>
    <span>
               ...
               <b-col cols="12">
                <b-form-group label="Descrição: *">
                  <b-input-group class="mb-3">
                   ...
                   <b-form-textarea id="textarea" v-model="perfil.descricao" rows="3" max-rows="6" :state="true"></b-form-textarea>
            ...
            <b-row>
                 <b-col cols="12">
                    <b-form-group label="Status: *">
                        <b-form-radio-group v-model="perfil.ativo" :state="true" id="radio-slots" :options="options" name="radio-options-slots"/>
                    </b-form-group>
                 </b-col>
             </b-row>
            <b-row>
        ...
        <b-card-footer class="p-12">
            <b-button v-if="can('perfil.update')" variant="primary" @click="onSubmit"><i class="fa fa-check"></i> Salvar</b-button>
